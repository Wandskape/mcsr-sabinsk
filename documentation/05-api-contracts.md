...
флаг `showThirdPlace` управляет только её отображением.
...
Победитель и его позиция в следующем раунде задаются администратором вручную.
Каждое изменение матча увеличивает версии матча и сетки. Для публикации должны
быть заполнены обе позиции всех матчей первого раунда.
